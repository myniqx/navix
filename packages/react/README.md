...
- **Don't omit `panelRootProps` if you have several panels stacked / animated wrappers.** It is the wrapper _closest to the visible panel surface_ that should receive these props; outer animation containers are usually wrong because they fill the screen during transforms.
