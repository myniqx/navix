 ...
 * Uses <NavixGrid> from the react adapter which attaches GridBehavior to the node:
 ...
 * so up/down wraps within the grid before bubbling to the parent NavixVerticalList.
 *
 * Props:
 *   onPlay — called when the user confirms Play on a card.
 */

import { NavixGrid } from '@navix/react';
